...
export async function generateMetadata({ params }: SkillPageProps) {
  ...
  if (!skill) {
    return { title: 'Skill non trouvé' }
  }

  return {
    title: skill.name,
    description: skill.shortDescription ?? `Découvrez ${skill.name} sur RobotSkills`,
  }
}
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-muted-foreground mb-3">{skill.shortDescription}</p>
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  {skill.latestVersion && (
                    <Badge
                      variant="outline"
                      className={riskColors[skill.latestVersion.riskLevel]}
                    >
                      <Shield className="h-3 w-3 mr-1" />
                      Risque {skill.latestVersion.riskLevel}
                    </Badge>
                  )}
                </div>
              </div>
            ...
            {screenshots.length > 0 && (
              <div className="space-y-4">
                <h2 className="text-lg font-semibold">Captures d&apos;écran</h2>
            ...
            <Tabs defaultValue="description">
              ...
              <TabsContent value="description" className="prose dark:prose-invert max-w-none mt-6">
                {skill.descriptionMd ? (
                  <div dangerouslySetInnerHTML={{ __html: skill.descriptionMd }} />
                ) : (
              ...
              <TabsContent value="changelog" className="mt-6">
                {skill.latestVersion?.releaseNotes ? (
                  ...
                  <p className="text-muted-foreground">Aucun changelog disponible.</p>
                )}
              </TabsContent>
              ...
              <TabsContent value="permissions" className="mt-6">
                <div className="rounded-lg border p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-medium mb-1">Permissions requises</h3>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">{skill.ownerName ?? 'Anonyme'}</span>
                </div>
                <Separator />
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground flex items-center gap-2">
