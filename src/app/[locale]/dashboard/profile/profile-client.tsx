  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex items-center gap-6">
        ...
        <div>
          <p className="text-sm font-medium">{t('profilePicture')}</p>
          <p className="text-sm text-muted-foreground">{t('pictureFormats')}</p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t('rolesPermissionsDesc')}</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between py-2 border-b">
                  ...
                  <span
                    className={`text-sm font-medium ${user.isDeveloper ? 'text-green-600' : 'text-muted-foreground'}`}
                  >
                    {user.isDeveloper ? (
                ...
                <div className="flex items-center justify-between py-2 border-b">
                  ...
                  <span
                    className={`text-sm font-medium ${user.isAdmin ? 'text-green-600' : 'text-muted-foreground'}`}
                  >
                    {user.isAdmin ? (
                      <span className="flex items-center gap-1">
                        <Check className="h-4 w-4" />
              ...
              {user.organizations.length > 0 && (
                <div className="mt-6">
                  <h4 className="text-sm font-medium mb-3">{t('organizations')}</h4>
                  <div className="space-y-2">
