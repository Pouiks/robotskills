      ...
      <div className="container">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Gérez vos skills installés et vos téléchargements
          </p>
        </div>
        ...
        <Tabs defaultValue="installed">
          <TabsList>
            <TabsTrigger value="installed">
              Installés ({mockInstallations.filter((i) => i.status === 'installed').length})
            </TabsTrigger>
            <TabsTrigger value="downloads">
              Téléchargements ({mockDownloads.length})
            </TabsTrigger>
          </TabsList>
              ...
              <Card>
                <CardContent className="py-12">
                  <div className="text-center">
                    ...
                    <h3 className="text-lg font-semibold mb-2">Aucun skill installé</h3>
                    <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
                      Vous n&apos;avez pas encore installé de skills. Explorez le store pour trouver des skills pour vos robots.
                    </p>
                    <Button asChild>
                      <Link href="/store">
                        Explorer le Store
              ...
              <Card>
                <CardContent className="py-12">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
                      Vous n&apos;avez pas encore téléchargé de skills.
                    </p>
                    <Button asChild>
                      <Link href="/store">
                        Explorer le Store
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">
                              v{download.version} • Téléchargé le{' '}
                              {new Date(download.downloadedAt).toLocaleDateString('fr-FR')}
                            </div>
                          </div>
                        </div>
                        <Button variant="outline" size="sm" asChild>
                          <Link href={`/skills/${download.skillSlug}`}>Installer</Link>
                        </Button>
                      </div>
                    </CardContent>
                  </Card>
